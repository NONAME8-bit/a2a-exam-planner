...
class ExamGeneratorAgentExecutor(AgentExecutor):
    """ExamGenerator's Exam Generator AgentExecutor."""
    ...
    async def execute(
        ...
        #  Debug: log exactly what ExamGeneratorn got
        logger.info(" ExamGeneratorn received message text:\n%s", query)
